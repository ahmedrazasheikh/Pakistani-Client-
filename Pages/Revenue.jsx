...
import { TouchableOpacityBase } from 'react-native/Libraries/Components/Touchable/TouchableOpacity';
...
{/* Chart1 */}
<TouchableOpacity     onPress={pageTransfer}  style={styles.centerContent} >
{/* Here Put The Chart  */}


<Image
        style={styles.tinyLogo}
        source={{uri:'https://cdn-icons-png.flaticon.com/128/4370/4370660.png'}}

      />
<Text  style={styles.BoldText} >Total sale  </Text>
<Text  style={styles.Number} >123,554</Text>
<Text     style={styles.BlackSetColor} >Riyal</Text>
</TouchableOpacity>
...
<Image
      ...
      />
{/* Here Put The Chart  */}
<Text  style={styles.BoldText} > Credit sale </Text>
<Text  style={styles.Number} >123,554</Text>
<Text      style={styles.BlackSetColor} >Riyal</Text>
</TouchableOpacity>
...
{/* Thirs  Chart  */}
<TouchableOpacity        onPress={pageTransfer}   style={styles.centerContent1}>
{/* Here Put The Chart  */}
<Image
        style={styles.tinyLogo}
        source={{uri:'https://cdn-icons-png.flaticon.com/128/4370/4370660.png'}}
      ...
      />
<Text  style={styles.BoldText} >   Cash sale  </Text>
<Text  style={styles.Number} >123,554</Text>
<Text      style={styles.BlackSetColor}>Riyal</Text>
</TouchableOpacity>
...
<View      style={[styles.InnerMain, {width : "100%"   } ]}           >
  <Text    style={[styles.OuterText , {color  : "black"   } ]}  >Total Invoices  <Text  style={[styles.InnerText ]}   >2322</Text>  </Text>
  <Text style={{color : "black"}} >Total Purchase   <Text   style={[styles.InnerText  ]}  >123456 Riyal        </Text>    </Text>
</View>
